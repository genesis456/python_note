...
* 字节串转换为字符串方法 : bytes.decode() 
  ...
  **所有的字符串都可以转为字节串，并不是所有字节串都能转为字符串**
...
```python
file_object = open(file_name, access_mode='r', buffering=-1) #绝对路径，相对路径都可以
功能：打开一个文件，返回一个文件对象。
参数：file_name  文件名；
...
![image-20200321130157024](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200321130157024.png)
...
![image-20200321202429305](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200321202429305.png)
...
3. 目标主机由物理层逐层解析首部消息包，最终到应用程序呈现消息。
   ...
   ![image-20200322160032824](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200322160032824.png)

![image-20200321202503171](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200321202503171.png)
...
![image-20200322155226706](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200322155226706.png)
...
![image-20200322155516185](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200322155516185.png)
...
![image-20200325141922280](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200325141922280.png)
...
>网络地址 ： '172.40.91.185'
>自动获取地址： '0.0.0.0'     (自己和别人都能访问，本地地址和网络地址都可以访问)

![image-20200322155609414](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200322155609414.png)
...
![image-20200322155631731](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200322155631731.png)
...
>影响：如果每次发送内容是一个独立的含义，需要接收端独立解析此时粘包会有影响。粘包
>
...
#### 服务端流程(无需建立连接，谁发过来直接接)

![image-20200322155657997](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200322155657997.png)
...
![image-20200322155714039](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200322155714039.png)
...
<img src="C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200322155833834.png" alt="image-20200322155833834" style="zoom:200%;" />
...
![image-20200322155928647](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200322155928647.png)
...
![image-20200325135346257](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200325135346257.png)
