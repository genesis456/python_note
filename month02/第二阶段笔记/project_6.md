...
![image-20200418143619302](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200418143619302.png)
...
3. 将工作内容记录到暂存区  （做完此步一定记得-->将暂存区所有记录同步到仓库区）
...
7. 比较工作区文件和仓库文件差异（修改工作区的内容，比较两者修改的地方）

> git diff  [file]

8. 将暂存区或者某个commit点文件恢复到工作区（**在提交前发现修改有误，可以放弃本次修改，执行此命令回到修改前**）
...
1. 退回到上一个commit节点，用命令`git reset HEAD `可以把暂存区的修改撤销掉（unstage），重新放回工作区，也可以回退版本。（**可以将删除的文件撤回到缓存区，用git checkout -- [file]又可以从缓存区拿回到工作区**）

> git reset --hard HEAD^
> 注意 ： 一个^表示回退1个版本，依次类推。当版本回退之后工作区会自动和当前commit版本保持一致

2. 退回到指定的commit_id节点   （**可以先用git log或git log --pretty=oneline查看需撤回到哪一步，复制其前7位commit号，再使用盖命令撤回 **

> git reset --hard [commit_id]

3. 查看所有操作记录  （**此记录是关机前的所有操作记录，即使删除了仓库的日志记录，通过操作记录的commit号（700c6d9 HEAD@{0}）还是可以通过git reset --hard [commit_id]回到原来被删之前**）
...
![image-20200421103524646](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200421103524646.png)
...
![image-20200418143646697](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200418143646697.png)
...
![image-20200421103323541](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200421103323541.png)
...
![image-20200418143744833](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200418143744833.png)

* 选择项目后复制项目git地址

![image-20200418143759314](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200418143759314.png)
...
![image-20200418143815764](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200418143815764.png)
...
![image-20200418143826856](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200418143826856.png)
![image-20200418143844544](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200418143844544.png)

### 远程仓库操作命令

<img src="C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20200420164834569.png" alt="image-20200420164834569" style="zoom:50%;" />

所有操作在本地git仓库下进行

1. 添加远程仓库（origin远程仓库名（自定义的，通常使用origin）

   git@github.com:genesis456/python_note.git 直接在github中需连接的仓库复制地址
